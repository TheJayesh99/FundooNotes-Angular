...
describe('BinComponent', () => {
  ...
  it('on delete notes delete should be called ',()=>{
    const note:Notes = {
      id: 0,
      title: 'new title',
    ...
    spyOn(component.auth,'deleteNote').and.callFake(()=>{
      return of(true)
    })
    component.deleteNote(note)
    expect(component.auth.deleteNote).toHaveBeenCalled()
  })
  
  it('on undo delete notes ahould updateNote component ',()=>{
    const note:Notes = {
      id: 0,
      title: 'new title',
      description: 'new desc',
